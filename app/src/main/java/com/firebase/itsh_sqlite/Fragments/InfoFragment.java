...
public class InfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView info=vista.findViewById(R.id.TxtInfo);

        info.setText("Instituto Tecnologico Superior de Huatusco\nISC Juan Miguel Zavaleta Martinez 8 Semestre\nBases de Datos para Dispositivos Moviles\nGestor de Registros SQLITE");
        return vista;
    }
